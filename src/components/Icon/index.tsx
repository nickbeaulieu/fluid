...
export const SvgFill: React.FC<{ size?: number; className?: string }> = ({
    size,
    children,
    className = '',
}) => {
...
export const SvgStroke: React.FC<{ size?: number; className?: string }> = ({
    size,
    children,
    className = '',
}) => {
...
export const Icon: React.FC<IconProps> = ({ type = 'stroke', icon, size, className = '' }) => {
    switch (icon) {
        case 'academic-cap':
            return type === 'fill' ? (
                <SvgFill size={size} className={className}>
                ...
                <SvgStroke size={size} className={className}>
